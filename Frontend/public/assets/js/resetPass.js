var app = {
  ...
  resetPassword: function(data) {
    ...
    jqxhr.done(function (response) {
      if (response.success)
      {
        var div = $('<div>').html('Votre mot de passe a bien été modifié, vous pouvez vous connecter').addClass('error bg-success text-light text-center rounded p-2 mt-2 mb-2');
    ...
    jqxhr.fail(function () {
      console.log('Echec resquest reset pass');
    });
  }
};
$(app.init);