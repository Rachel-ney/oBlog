<div class="row all-form">
    <main class="col-lg-12 d-lg-flex flex-lg-row  ">
        
        <form class="col-12 col-lg-5 mb-3 mx-auto border d-flex flex-column sign-in ">
        ...
        <form class="col-12 col-lg-5 mb-3 mx-auto border register">
