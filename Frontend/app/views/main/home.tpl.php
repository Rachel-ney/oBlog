...
<div class="row ">
    <main class="col-12 col-md-8 col-lg-5 mx-auto">
        <h1 class="text-center mb-4">Bienvenue sur oBlog... à la dérive</h1>
        ...
        <p class="h3 text-center bg-light border-top border-bottom py-3">En bref ?</p>
        <p class="text-center">Lâchez-vous !</p>
    </main>
