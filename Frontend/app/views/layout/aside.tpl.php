        <aside class="col-3 col-lg-2 mr-2 pt-3 aside-absolute">
          <!-- Catégories: https://getbootstrap.com/docs/4.1/components/card/#list-groups-->
          <div class="card">
            <h3 class="card-header">Catégories</h3>
            <ul class="list-group list-group-flush category-aside">
              <li class="list-group-item d-none"> <a href="">Category Name</a></li>
              <li class="list-group-item d-none"> <a href="">Category Name</a></li>
            </ul>
          </div>
